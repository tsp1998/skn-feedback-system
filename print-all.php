...
<body>
	...
	?>
	<center>
		<h3>SKN Sinhgad College of Engineering, Korti.</h3>
	</center>
	<table width="100%">
		<tr>
			<td width="33%"><b>
	...
	<table width="100%" border="1">
		<tr>
			<th rowspan='3' width="7%">Sr. No.</th>
			<th rowspan='3' width="30%">Parameter</th>
			<?php
			include 'db_conn.php';
	...
	<table width="100%" border="1">
		<tr>
			<th rowspan='3' width="7%">Sr. No.</th>
			<th class='header' rowspan='3' width="30%">Parameter</th>
